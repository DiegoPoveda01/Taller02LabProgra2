...
6) Salir""");
    ...
    private static void menuBuscarLibro(String[][] coleccionDeLibros) {
        ...
        String tituloLibro = pedirInput();

        buscarLibro(coleccionDeLibros, tituloLibro);
    }
    ...
    public static void buscarLibro(String [][] coleccionDeLibros, String titulo) {
        for(int i = 0; i < coleccionDeLibros.length; i++) {
            ...
            else System.out.println("Libro \"" + titulo + "\" no encontrado.");
        }
    }
...
return opcionIngresada;
    ...
    public static boolean opcionInvalida(int opcionIngresada) {
        return opcionIngresada > 6 && opcionIngresada < 0;
    }

    public static int quehace() {
        Scanner leer = new Scanner(System.in);
        int opcionIngresada;
        ...
        }while(opcionInvalida(opcionIngresada));
